...
/* Fix smooth scrolling area for the reservations table */
.res-table-container {
    width: 100%;
    max-height: 300px; /* you can increase this if you want taller area */
    overflow-x: auto;
    overflow-y: auto;
    border-radius: 10px;
    background: #fff;
...
/* Wider table to allow horizontal scrolling comfortably */
.res-card table {
    width: 950px; /* this ensures both scrollbars appear naturally */
...
/* Slight zebra effect for better readability */
.res-card tbody tr:nth-child(even) {
    background-color: #f9fcff;
}
.res-card tbody tr:hover {
    background-color: #e6f7ff;
}

/* Clean scrollbars for Chrome/Edge */
.res-table-container::-webkit-scrollbar {
    height: 8px;
    width: 8px;
}
.res-table-container::-webkit-scrollbar-thumb {
    background: #b0c4de;
    border-radius: 8px;
}
.res-table-container::-webkit-scrollbar-thumb:hover {
    background: #708090;
}
